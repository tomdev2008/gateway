...
public class ERPOrder {
    ...
    public void setConsignee_name(String consignee_name) {
        ...
        getReceiver_info().put("consignee_name", consignee_name);
    }
    ...
    public void setPhone(String phone) {
        this.phone = phone;
        getReceiver_info().put("phone", phone);
    }
    ...
    public void setMobile(String mobile) {
        this.mobile = mobile;
        getReceiver_info().put("mobile", mobile);
    }
    ...
    public void setProvince(String province) {
        ...
        getReceiver_info().put("province", province);
    }
    ...
    public void setCity(String city) {
        this.city = city;
        getReceiver_info().put("city", city);
    }
    ...
    public void setDistrict(String district) {
        ...
        getReceiver_info().put("district", district);
    }
    ...
    public void setAddress(String address) {
        ...
        getReceiver_info().put("address", address);
    }
    ...
    public void setZip_code(String zip_code) {
        ...
        getReceiver_info().put("zip_code", zip_code);
    }
    ...
    public void setEmail(String email) {
        this.email = email;
        getReceiver_info().put("email", email);
    }
    ...
    public void setArea_code(String area_code) {
        ...
        getReceiver_info().put("area_code", area_code);
    }
